...
class Game{
  ...
  constructor(contGame, level, prog, chor, speed, maxMilliseconds, containerActions) {
    ...
    this.uriJson = "https://api-restt-default-rtdb.firebaseio.com/api/users.json"; // path data JSON
    this.pathImg = "/SENA/SENA_ADSO/games/games_memory/assets/img/memory/"; // path data imgs 
    this.pathImgDafault = "/SENA/SENA_ADSO/games/games_memory/assets/img/memory/img_default.jpg"; // path data img default 
    ...
    getProgressvalue(value) {
      if (value == 100) {
          ...
          // Detener el cronómetro aquí
          this.objChronometer.stopChronometer();
          
          // Opcional: Muestra una animación o mensaje de juego completado
          ...
          this.setTimeOut(); // Considera si es necesario o deseas manejar el fin de juego de otra manera.
      }
  }
